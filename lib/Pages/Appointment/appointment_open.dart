...
class AppointmentOpen extends StatefulWidget {
  const AppointmentOpen({Key? key}) : super(key: key);

  @override
  State<AppointmentOpen> createState() => _AppointmentOpenState();
}

class _AppointmentOpenState extends State<AppointmentOpen> {
